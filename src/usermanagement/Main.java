...
public class Main {
	public static void main(String[] args) {
		...
		userProfileManager.setUsers(users); // Set the loaded users
		...
		do {
			...
			switch (choice) {
			case 1:
				registerUser(userProfileManager, userFactory, scanner);
				// Save the updated user information to the CSV file
				csvHandler.writeUsersToCSV(userProfileManager.getUsers());
				break;
			case 2:
				loginUser(userProfileManager, scanner);
				break;
			case 3:
				editUserProfile(userProfileManager, scanner);
				// Save the updated user information to the CSV file
				csvHandler.writeUsersToCSV(userProfileManager.getUsers());
				break;
			case 4:
	...
	private static void registerUser(UserProfileManager userProfileManager, UserFactory userFactory, Scanner scanner) {
